            ...
            <div className='projects-container'>
                <div className='projects-left' id='projects-left'>
                    <div className='projects-left-left'>
                        ...
                        {   
                            currentVideo === 'roobinhud' ? <img className='window-logo' id='roobinhud-logo' src='https://robinhood-clone-assets.s3.amazonaws.com/logo_full_white.png' alt='roobinhud-logo'></img> : <></>
                        }
                        {   
                            currentVideo === 'linealert' ? <img className='window-logo' id='linealert-logo' src='https://linealert-assets.s3.amazonaws.com/linealert_logo_full.png' alt='linealert-logo'></img> : <></>
                        }
                        {   
                            currentVideo === 'beatbox' ? <img className='window-logo' id='beatbox-logo' src='https://tomleslieli.github.io/BeatBox/assets/images/BEATBOXLOGO.png' alt='beatbox-logo'></img> : <></>
                        }
                        </div>
                        <div className='video-window'>
                            ...
                            <div onClick={() => setCurrentVideo('rick')} className='projects-window' id='projects-window-button'>
                                <ProjectsWindowButtons/>
                            </div>
                        </div>
                        <div className='video-demo-instructions'>
                        {   
                            currentVideo === 'default' ? <h6>Select a project for a video demo.</h6> : <></>
                        }
                        </div>
                    </div>
                </div>
                <div className='timeline-line'>
                        <div className='timeline-marker' onClick={() => setCurrentVideo('beatbox')}/>
                        <div className='timeline-marker'onClick={() => setCurrentVideo('roobinhud')}/>
                        <div className='timeline-marker' onClick={() => setCurrentVideo('linealert')}/>
                    </div>
